...
from models.resnet import ResNet_change
from models.cca import CCA
from models.mpi import MPI


class MPINet(nn.Module):

    def __init__(self, args, mode=None):  # 修改这里
        super().__init__()  # 注意这里也是 __init__
        ...
        # self.encoder = Conv32F()
        # self.encoder = Conv64F()
        # self.encoder = WideResNet()
        self.encoder = ResNet_change(args=args)
        ...
        self.MPI_1 = MPI(self.encoder_dim)
        self.MPI_2 = MPI(self.encoder_dim)
        self.MPI_3 = MPI(self.encoder_dim)
        self.MPI_4 = MPI(self.encoder_dim)
        self.MPI_5 = MPI(self.encoder_dim)
